				...
				if(opcion.equals("1")) {
					...
					if (listaHechiceros.size() >= 3) {
						for (int i = 0; i < 3; i++) { // : listaHechiceros.get(i).getPuntuacion()
							System.out.println((i+1) +"- " + "El Hechicero " + listaHechiceros.get(i).getNombre()+" ");
							}
					}
					...
					if (listadeHechizos.isEmpty()) {
						...
						for (int i = 0; i < listadeHechizos.size(); i++) {
							System.out.println((i+1) + "- "+""+listadeHechizos.get(i).getNombreHechizo() +" : "+ listadeHechizos.get(i).calcularPuntaje()+"");
						}
					}
				}
					...
					for (int i = 0; i < listaHechiceros.size(); i++) {
						System.out.println((i+1) +"-" +listaHechiceros.get(i).getNombre()+ " : "+listaHechiceros.get(i).getPuntuacion());
							}
						}
					}
